...
async function sendEmail(userEmail, ticketLink) {
  try {
    const msg = {
      ...
      subject: "Invitation from wpConnect",
        ...
        <tr>
          ...
          >
            <div class="main">
              ...
              >
                <img
                  src="https://raw.githubusercontent.com/hWeitian/wpconnect-frontend/main/src/assets/logo.png"
                  width="350"
                  alt="wpconnectg logo"
              ...
              <p>The administrator has invited you to access wpConnect</p>
              
              <p>
                <strong><a href="${ticketLink}">Click here</a></strong> to accept the invitation.
              </p>
              
              <strong>wpConnect</strong>
